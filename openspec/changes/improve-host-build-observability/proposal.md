...
- Affects host progress/event DTOs, facade rendering and output configuration, build/Pi orchestration, streaming HTTP transports, Pi release acquisition, npm stream dispatch, and failure rendering.
