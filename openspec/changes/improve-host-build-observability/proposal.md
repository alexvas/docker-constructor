...
- Simplify the current internal presentation path to one bounded ordered inbox and one facade actor, with reserved control capacity, short mutex-protected admission, bounded drop accounting, and capacity-independent inbox close. Keep collection and retained tails independent of terminal throughput; preserve the optional external SDK sink contract.
